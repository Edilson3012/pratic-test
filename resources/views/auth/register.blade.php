                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            {{-- Type field --}}
                            <div class="row mb-3">
                                <label for="type" class="col-md-4 col-form-label text-md-end">CPF ou CNPJ</label>
                                <div class="col-md-6">
                                    <select name="type" id="type" class="form-control select2"
                                        onchange="limparDocumento()">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="document" onblur="validarDocumento()" name="document"
                                        class="form-control required" placeholder="Documento" autofocus>
                                </div>
                                @error('document')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
